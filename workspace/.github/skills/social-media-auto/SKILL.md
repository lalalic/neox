...
```
web-agent navigate url=https://creator.xiaohongshu.com
```
...
Type into a field:
```
web-agent type ref=r3 text=Your content here
```

Click buttons:
```
web-agent click ref=r5
```

Upload files:
```
web-agent upload ref=r7 filePath=/path/to/file
```
